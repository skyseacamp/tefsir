...
export default function AyetsPage() {
  ...
  const fetchAyets = useCallback(async () => {
    setLoading(true);
    try {
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, ayetNo: e.target.value })
                  }
                  className="w-full border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  required
                  placeholder="e.g. 255"
                ...
                {loading ? (
                  ...
                  ayets.map((ayet) => (
                    <tr key={ayet._id} className="hover:bg-gray-50">
                      ...
                      <td
                        className="px-6 py-4 text-gray-800 font-arabic text-right text-lg truncate max-w-xs"
                        dir="rtl"
                      >
                        {ayet.arapca}
                      </td>
