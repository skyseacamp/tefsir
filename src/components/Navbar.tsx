...
export default function Navbar() {
  ...
  const navigation = [
    { name: "Home", href: "/", current: isActivePath(pathname, "/", true) },
    ...(user
      ? [
        {
          name: "Create Presentation",
          href: "/create-presentation",
          current: isActivePath(pathname, "/create-presentation"),
        },
      ]
      : []),
    ...(user?.role === "admin"
      ? [
        {
          ...
          href: "/admin",
          current: isActivePath(pathname, "/admin"),
        },
      ]
      : []),
  ];
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center">
              <Image alt="Tefsir" src={logo} className="h-8 w-auto" />
            </div>
